...
def run_interaction_evaluation(exp_path, gt_tfs_path,tfdatabase,  method = "SATORI",  motif_weights=False):
    ...
    base_path = "/s/chromatin/a/nobackup/Saira/SATORI_ENHANCEMENTS/satoriv2/"
    output_folder =  os.path.join(base_path, exp_path)
    print(output_folder, "path exists ?" , os.path.exists(output_folder))
    ...
    print(output_folder, interaction_files)
