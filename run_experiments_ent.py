...
def run(mode):
    ...
    dataset_path ="/s/chromatin/p/nobackup/Saira/original/satori/data/ToyData/NEWDATA/clustered_tfs/"   # "data/LongSimulated_Data/Data-40/" 
    d_files = ["ctf_80pairs_0","ctf_80pairs_1","ctf_80pairs_2"] #["seqs_1500bp_3","seqs_1500bp_2","seqs_1500bp_1" ] #["seqs_80_1" , "seqs_80_2", "seqs_80_3"]  #"seqs_80_2" run deep E3 and deep entropy 
    ...
    hyperparams_dirs = ["modelsparam/all_exps/simulated/basic/baseline_entropy_pe_0.01.txt"]
    loadmotfs = False
    best_val_auc = -1
    best_exp = ""
    best_seed = -1
    ...
    for d in d_files:
        outdir = "results/Data-80/Clustered/"  + d + "/"  #/selected_model"
