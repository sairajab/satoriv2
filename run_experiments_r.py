...
def run(mode):
    ...
    d_files = ["ctf_60pairs_eq2"]
    pairs_n_meme = {"ctf_40pairs" : ["tf_pairs_40.txt", "subset40.meme"] , 
                    "ctf_60pairs_eq2" : ["tf_pairs_60.txt", "subset60.meme"] ,
                    "ctf_60pairs_eq0" : ["tf_pairs_60.txt", "subset60.meme"] ,
                    "ctf_60pairs_eq1" : ["tf_pairs_60.txt", "subset60.meme"] ,
                    "ctf_80pairs" :  ["tf_pairs_80.txt", "subset80.meme"]}
    hyperparams_dirs = ["modelsparam/all_exps/baseline/baseline.tx"]
    for d in d_files:
        ...
        for hyperparams_dir in hyperparams_dirs:
            ...
            for param in modelparams:
                ...
                if exp in ["baseline_relative_ns", "baseline_relative_ns_entropy_0.01"]:
                     continue
